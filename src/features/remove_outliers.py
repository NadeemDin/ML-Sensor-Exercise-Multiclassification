...
df[["acc_x","label"]].boxplot(by='label',figsize = (20,20))
...
"""need to differentiate between each label, not all on one plot"""
# --------------------------------------------------------------
...
# Chauvenet's function - assumes normal distribution of data
...
# LOF function  (unsupervised model)
